...
opts = {'ControlLB', -0.01, ...
        ...
        'StochasticProblem', 1, ...
        'DiscountRate', 0.1, ...
        'UserConstraintFunctionFile', 'constraint_fn', ...
        'StateStepSize', state_step};

conf = iss_conf(state_lb, state_ub, opts{:});

save fisheries_stochastic_kernel_conf.mat delta_fn cost_fn state_lb state_ub opts

ocm = iss_solve(delta_fn, ...
                cost_fn, ...
                state_lb, state_ub, conf);

save fisheries_stochastic_kernel_ocm.mat ocm