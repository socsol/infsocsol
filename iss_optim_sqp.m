...
try
  if Options.StochasticProblem
    [UOptimal, ignore, info] = ...
        sqp(UStart, @(U) CostStoch(U, DeltaFunction, ...
                                   StageReturnFunction, ...
                                   ...
                                   Options.NoiseProb, ...
                                   Options.NoisyVars), ...
            G, H, Options.ControlLB, Options.ControlUB, ...
            Options.MaxIter, Options.TolX);
  else
    [UOptimal, ignore, info] = ...
        sqp(UStart, @(U) CostDeter(U, DeltaFunction, ...
                                   StageReturnFunction,...
